            ...
            [width fill]
                ...
                , row NoStyle
                    [width fill, center, paddingBottom 10]
                        [ newTab "https://barnstablecounty.sharepoint.com/:b:/g/dept/commission/team/EYXGq3UkHN9DgSR3Stb-GSUBskhVMducaNuUrwPDtYIpyg?e=KWgZ2d" <| el SelectShorelineButton [ width fill, height (px 26),paddingXY 6 3 ] (text "Download methods") ]
                ]
        ]