            ...
            [width fill]
                ...
                , row NoStyle
                    [width fill, center, paddingBottom 10]
                        [ newTab "https://barnstablecounty.sharepoint.com/:b:/g/dept/commission/team/EYXGq3UkHN9DgSR3Stb-GSUBqZPa8fL1ooaAgBCTgWbPsA?e=sClSPX" <| el SelectShorelineButton [ width fill, height (px 26),paddingXY 6 3 ] (text "Download Methods") ]
                ]
        ]