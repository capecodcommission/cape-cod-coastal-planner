...
export function layer(map) {
    ...
    layer.set("name", "disconnected_roads_1ft");
...
function _source() {
    ...
    let source = new XYZ({
        ...
        url: 'http://gis-services.capecodcommission.org/arcgis/rest/services/SeaLevelRise/Roads_Isolated_1ft/MapServer/tile/{z}/{y}/{x}',
        maxZoom: 16,
        minZoom: 3,
        opaque: false,
        transition: 4,
