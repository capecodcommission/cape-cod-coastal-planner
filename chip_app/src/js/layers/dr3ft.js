...
export function layer(map) {
    ...
    layer.set("name", "disconnected_roads_3ft");
...
function _source() {
    ...
    let source = new XYZ({
        ...
        url: 'http://gis-services.capecodcommission.org/arcgis/rest/services/SeaLevelRise/Roads_Isolated_3ft/MapServer/tile/{z}/{y}/{x}',
        maxZoom: 16,
        minZoom: 3,
        opaque: false,
        transition: 4,
