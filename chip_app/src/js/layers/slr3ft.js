...
export function layer(map) {
    ...
    layer.set("name", "sea_level_rise_3ft");

    map.on("render_slr3ft", ({data}) => {
      onRenderSLR(data, layer, source);
    });

    map.on("disable_slr3ft", () => {
...
function _source() {
    ...
    let source = new XYZ({
        ...
        url: 'http://gis-services.capecodcommission.org/arcgis/rest/services/SeaLevelRise/SLR_3_Corrected/MapServer/tile/{z}/{y}/{x}',
        maxZoom: 16,
        minZoom: 3,
        opaque: false,
        transition: 4,
